...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("evaluated_readiness_level", sa.String(length=40), nullable=True),
        sa.Column("readiness_mapping_policy_code", sa.String(length=100), nullable=True),
        sa.Column("readiness_mapping_policy_version", sa.String(length=30), nullable=True),
        sa.Column("warnings", portable_json, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("result_locator", sa.String(length=100), nullable=True),
