...
def test_capability_shadow_evaluation_stage_completes_and_persists_decisions(
    ...
    # XDOM-A/XDOM-B. P3.xxI.5B adds MAINTENANCE-REPEAT-VISIT, and P3.xxI.6
    # adds MAINTENANCE-SCHEDULE-COMPLETION-GAP, through that same governed
    # machinery -- all are expected here, not regressions.
    assert rule_codes <= {
